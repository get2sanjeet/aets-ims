...
public class EAN13CodeBuilder {
    ...
    private void parse()
    {
        ...
        this.fullCode = fullString;
        generatedCode = createEAN13Code(fullString);
    }

    public static void main(String[] args) {
        EAN13CodeBuilder ean13CodeBuilder = new EAN13CodeBuilder("824958768310");
        //System.out.println(ean13CodeBuilder.getCode());;
    }
}
