...
public class BaseController implements Initializable{
    ...
    @FXML
    private JFXButton btnInventoryService;
    @FXML
    ...
    private void ctrlRightPane(String URL) throws IOException {
        try {
            ...
            System.out.println("H-"+paneRight.getHeight()+"/W-"+paneRight.getWidth());
    ...
    private void loadFXMLMap() {
        ...
        FXML_URL.put("Products", "/main/resources/view/inventory.fxml");
        FXML_URL.put("Services", "/main/resources/view/inventory.fxml");
        FXML_URL.put("Customers", "/main/resources/view/customer.fxml");
        FXML_URL.put("Dashboard", "/main/resources/view/dashboard.fxml");
        FXML_URL.put("Orders", "/main/resources/view/sells.fxml");
