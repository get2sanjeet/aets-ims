...
public class LogInController implements Initializable{
    ...
    public void initialize(java.net.URL location, ResourceBundle resources) {
        ...
        Platform.runLater(() -> createDirectories());
    }

    private void createDirectories() {
        try {
            Files.createDirectories(Paths.get(BarCodeUtility.BAR_CODE_PATH));
            Files.createDirectories(Paths.get(BarCodeUtility.BILL_PATH));
        } catch (IOException e) {
