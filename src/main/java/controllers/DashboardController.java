...
public class DashboardController implements Initializable{
    ...
    @FXML
    private LineChart lineChartOrders;
    @FXML
    ...
    private void setLineChart(){
        ...
        series.getData().add(new XYChart.Data("Jan'23", 15));
        series.getData().add(new XYChart.Data("Feb'23", 16));
        series.getData().add(new XYChart.Data("Mar'23", 17));
        series.getData().add(new XYChart.Data("Apr'23", 18));
        series.getData().add(new XYChart.Data("May'23", 19));
        series.getData().add(new XYChart.Data("Jun'23", 25));
        series.getData().add(new XYChart.Data("Jul'23", 29));
